...
public class AnimationViewer extends JPanel implements ActionListener {
	...
	public AnimationViewer() {
		...
		CarrierShape _topLevelNest = new CarrierShape(100, 100, 2, 2, 350, 350);
		CarrierShape _midLevelNest = new CarrierShape(0, 0, 2, 2, 200, 200);
		CarrierShape _bottomLevelNest = new CarrierShape(5, 5, 2, 2, 30, 30);
		DynamicRectangleShape _simpleShape = new DynamicRectangleShape(1, 10, 2, 1, 15, 15);
		RectangleShape rectangle = new RectangleShape();
		
		//add text to all shapes
		rectangle.addText("I'm rectangle");
		_topLevelNest.addText("I'm top");
		_midLevelNest.addText("I'm mid");
		_simpleShape.addText("I'm simpleShape");
		_bottomLevelNest.addText("I'm bottom");
