 ...
 * 
 * For the SpaceShape application, for example, a FormComponent might contain two
 ...
 * field data. In the SpaceShape application, FormHandler implementations create
 * different kinds of Shapes based on form data.
 * 
 * @see spaceshapes.forms.util.Form
 * @see spaceshapes.forms.util.FormElementComponent
 * 
 * @author Ian Warren
 *
 */
